...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed inset-x-0 top-4 z-50 flex items-center justify-center pointer-events-none p-4',
      className
    )}
    {...props}
  />
